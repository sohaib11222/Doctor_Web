...
const VideoCallRoom = () => {
  ...
  // Get doctor info from location state or use defaults
          ...
          <div className="row">
            <div className="col-lg-10 mx-auto">
              <div className="call-ended text-center py-5">
                ...
                <h3>Call Ended</h3>
                <p className="text-muted">The video call has been ended.</p>
                <Link to="/patient-appointments" className="btn btn-primary mt-3">
                        ...
                        <div className="navbar">
                          <div className="user-details">
                            <div className="float-start user-img">
                              <Link to="/patient-profile" className="avatar avatar-sm me-2" title={doctorInfo.name}>
                                <img src={doctorInfo.image} alt="User Image" className="rounded-circle" />
                                <span className="status online"></span>
                              </Link>
                            </div>
                            <div className="user-info float-start">
                              <Link to="/patient-profile"><span>{doctorInfo.name}</span></Link>
