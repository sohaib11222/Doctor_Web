        ...
        <div className="row">
          ...
          <div className="col-lg-12 col-xl-12">
            ...
            <div className="appointment-details-wrap">
                ...
                <ul className="detail-card-bottom-info">
                  ...
                  <li>
                    <div className="start-btn">
                      <a href="#" className="btn btn-secondary">Start Session</a>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              {/* Appointment Detail Card - Cancelled */}
              <div className="appointment-wrap appointment-detail-card">
                <ul>
                  <li>
                    <div className="patinet-information">
                ...
                <ul className="detail-card-bottom-info">
                  ...
                  <li>
                    <div className="detail-badge-info">
                      ...
                      <a href="/booking" className="reschedule-btn btn-primary-border">Reschedule Appointment</a>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              {/* Appointment Detail Card - Completed */}
              <div className="appointment-wrap appointment-detail-card">
                <ul>
                  <li>
                    <div className="patinet-information">
                ...
                <ul className="detail-card-bottom-info">
                  ...
                  <li className="detail-badge-info">
                    <a href="#view_prescription" data-bs-toggle="modal" className="btn btn-primary prime-btn me-3">Download Prescription</a>
                    <a href="#" className="btn reschedule-btn btn-primary-border">Reschedule Appointment</a>
                  </li>
                </ul>
              </div>
              {/* /Appointment Detail Card */}
